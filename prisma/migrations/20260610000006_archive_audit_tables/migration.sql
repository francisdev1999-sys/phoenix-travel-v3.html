...
ALTER TABLE "ArchiveAuditFinding" ADD CONSTRAINT "ArchiveAuditFinding_runId_fkey"
  FOREIGN KEY ("runId") REFERENCES "ArchiveAuditRun"("id") ON DELETE CASCADE ON UPDATE CASCADE;
