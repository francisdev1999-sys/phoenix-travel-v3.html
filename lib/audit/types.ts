...
export interface AuditSettings {
  ...
  aiModel:                  string;
  maxNodesPerAiRun:         number;
  maxFindingsPerRun:        number;
  weakEdgeThreshold:        number;
  duplicateTitleThreshold:  number;
  autoApproveOrphans:       boolean;
  autoApproveStaleEdges:    boolean;
  autoApproveWeakEdges:     boolean;
}
...
export const FINDING_LABELS: Record<FindingType, string> = {
  orphan:            'Orphan Node',
  stale_edge:        'Stale Connection',
  weak_edge:         'Weak Connection',
  missing_fields:    'Incomplete Node',
  duplicate:         'Possible Duplicate',
  source_quality:    'Source Quality',
  ai_quality:        'AI Quality Flag',
